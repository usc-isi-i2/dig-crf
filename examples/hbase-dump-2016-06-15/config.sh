...
TITLE_AND_TEXT_TOKENS_FILE=title-and-text-tokens.seq
WORKING_TITLE_AND_TEXT_TOKENS_FILE=${DATASET_WORK_DIR}/${TITLE_AND_TEXT_TOKENS_FILE}
...
PRODUCTION_TITLE_AND_TEXT_TOKENS_FILE=${HDFS_CRF_DATA_DIR}/${TITLE_AND_TEXT_TOKENS_FILE}
