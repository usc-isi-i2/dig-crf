...
PRODUCTION_NAME_ETHNIC__FILE=${HDFS_CRF_DATA_DIR}/${ETHNIC_FILE}
PRODUCTION_HAIR_EYES_HJ_FILE=${HDFS_CRF_DATA_DIR}/${HAIR_EYES_FILE}-hj
PRODUCTION_NAME_ETHNIC_HJ_FILE=${HDFS_CRF_DATA_DIR}/${ETHNIC_FILE}-hj
