...
WORKING_NAME_ETHNIC_FILE=${DATASET_WORK_DIR}/${NAME_ETHNIC_FILE}.seq
WORKING_NAME_ETHNIC_HJ_FILE=${DATASET_WORK_DIR}/${ETHNIC_FILE}-hj.seq

# These are the files we'll deliver:
PRODUCTION_HAIR_EYES_FILE=${HDFS_CRF_DATA_DIR}/${HAIR_EYES_FILE}
PRODUCTION_NAME_ETHNIC_FILE=${HDFS_CRF_DATA_DIR}/${ETHNIC_FILE}
