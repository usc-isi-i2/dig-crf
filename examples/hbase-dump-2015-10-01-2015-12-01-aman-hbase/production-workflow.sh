...
{ time ./applyCrfSjSparkDescMemexHairEyesFused.sh; } \
|& tee applyCrfSjSparkDescMemexHairEyesFused.log
...
{ time ./applyCrfSjSparkDescMemexNameEthnicFused.sh; } \
|& tee applyCrfSjSparkDescMemexNameEthnicFused.log
