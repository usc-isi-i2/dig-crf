...
RECORD_ID_PROPERTY=_id

SPARK_MASTER_MODE='local[32]'
...
HDFS_WORK_DIR=/home/ubuntu/github/dig-crf/examples/memex-2016-eval/work
HDFS_PRODUCTION_DIR=/cdr/tld_separated/
HDFS_INPUT_DATA_DIR=${HDFS_PRODUCTION_DIR}/extractions/${DATASET_NAME}
HDFS_CRF_DATA_DIR=${HDFS_PRODUCTION_DIR}/crf/${DATASET_NAME}
...
WORKING_TITLE_AND_TEXT_TOKENS_FILE=${DATASET_WORK_DIR}/title-and-text-tokens

HAIR_EYES_FILE=hair-eyes
WORKING_HAIR_EYES_FILE=${DATASET_WORK_DIR}/${HAIR_EYES_FILE}
WORKING_HAIR_EYES_HJ_FILE=${DATASET_WORK_DIR}/${HAIR_EYES_FILE}-hj
WORKING_HAIR_EYES_TOKENS_FILE=${DATASET_WORK_DIR}/${HAIR_EYES_FILE}-tokens
...
WORKING_NAME_ETHNIC_FILE=${DATASET_WORK_DIR}/${ETHNIC_FILE}
WORKING_NAME_ETHNIC_HJ_FILE=${DATASET_WORK_DIR}/${ETHNIC_FILE}-hj
WORKING_NAME_ETHNIC_TOKENS_FILE=${DATASET_WORK_DIR}/${NAME_ETHNIC_FILE}-tokens
